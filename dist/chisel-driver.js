 ...
 * Distribution file: vendor/elliptic-6-6-1.min.js
 * License: MIT. See THIRD_PARTY_LICENSES/elliptic.txt.
 *
 * Chisel v2.6.0 embeds this browser build directly so the signing path
 * no longer depends on a separate elliptic script tag. The original vendor
 * file remains in /vendor for audit comparison, but index.html and
 * qrScan.html no longer load it directly.
 */
...
*/
  ...
  CHISEL.installCoin(NAME, {
    ...
    DRIVER_CLASS: "coin-extension",
    TRANSPORT_MODES: ["proxy-rpc"],
...
function getRequiredFeeUnits(feeUnits, values) {
  ...
  CHISEL.installCoin(NAME, {
    ...
    REQUIRES_EXPLORER: REQUIRES_EXPLORER,
    DRIVER_CLASS: "coin-extension",
    TRANSPORT_MODES: ["external-utxo", "proxy-rpc"],
    DEFAULT_TRANSPORT_MODE: "proxy-rpc",
    UTXO_SOURCE: "external-explorer-address-txs",
    BROADCAST_SOURCE: "proxy-rpc-sendrawtransaction",
...
(function () {
  ...
  function makeLitecoinCoin(config) {
    ...
    return {
      ...
      DRIVER_CLASS: "coin-extension",
      TRANSPORT_MODES: ["public-provider"],
      DEFAULT_TRANSPORT_MODE: "public-provider",
...
(function () {
  if (!window.CHISEL) {
    throw new Error("CHISEL driver failed to initialize CHISEL global.");
  }
  ...
  window.CHISEL_DRIVER = {
    ...
    getCoins: function getCoins() {
      return window.CHISEL.getCoins().map(function mapCoin(coin) {
        return {
          name: coin.NAME,
          displayName: coin.DISPLAY_NAME,
          ticker: coin.TICKER,
          order: coin.ORDER,
          driverClass: coin.DRIVER_CLASS || "coin-extension",
          transportModes: coin.TRANSPORT_MODES || [],
          defaultTransportMode: coin.DEFAULT_TRANSPORT_MODE || "",
